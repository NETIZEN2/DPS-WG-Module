import { unitLibrary } from './entities.js';
import { refreshDetectionPanel } from './detectionPanel.js';
...
function bindUnitEvents(unitObject) {
    ...
    marker.on('mouseover', () => {
        if (activeAction.type || !rangeRingsVisible) return;
...
function updateDetections() {
    ...
    refreshDetectionPanel(activeMapUnits, flyToUnit);
}
...
export function initializeApp() {
    ...
    toggleRingsBtn.addEventListener('click', () => {
        ...
        activeMapUnits.forEach(unit => {
            unit.rangeCircles.forEach(circle => {
            ...
            unit.ringLabels.forEach(label => label.remove());
            unit.ringLabels = [];
        });
